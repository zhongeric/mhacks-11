...
adult_wordlist.to_csv('training_data_adult.csv', index = False, header = None)
child_wordlist.to_csv('training_data_child.csv', index = False, header = None)
infant_wordlist.to_csv('training_data_infant.csv', index = False, header = None)
